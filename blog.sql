...
CREATE TABLE `blog` (
  ...
  `summary` varchar(400) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '博客摘要',
  `createDate` datetime DEFAULT NULL COMMENT '发布日期',
  `releaseDate` datetime DEFAULT NULL COMMENT '修改日期',
  `clickHit` int(11) DEFAULT NULL COMMENT '点击次数',
  `commentHit` int(11) DEFAULT NULL COMMENT '评论次数',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '博客内容',
  `keyword` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '关键字',
  `blogTypeId` int(11) DEFAULT NULL COMMENT '外键关联博客类别',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `type_id` (`blogTypeId`) USING BTREE,
...
-- Records of blog
-- ----------------------------
INSERT INTO `blog` VALUES ('29', '测试20191204', 'SUMMARY', '2019-12-04 17:04:17', '2020-06-26 13:13:46', '39', '3', '<p>\n	<span style=\"font-size:24px;\">CRUD1</span>\n</p>\n<p>\n	<img src=\"http://localhost:8080/static/kindeditor/plugins/emoticons/images/13.gif\" border=\"0\" alt=\"\" /> \n</p>\n<p>\n	<img src=\"/upload/image/20191204/20191204170409_590.jpg\" alt=\"\" /> \n</p>', 'keyword', '2');
INSERT INTO `blog` VALUES ('30', '一天发一篇', '测试测试', '2019-12-04 17:04:17', '2019-12-05 08:57:58', '31', '0', '<p>\n	今天终结所有基本模块\n</p>\n<p>\n	<img src=\"http://localhost:8080/static/kindeditor/plugins/emoticons/images/13.gif\" border=\"0\" alt=\"\" />\n</p>\n<p>\n	<img src=\"/upload/image/20191205/20191205085742_746.jpeg\" alt=\"\" />\n</p>', 'OVER', '2');
INSERT INTO `blog` VALUES ('31', 'Required Integer parameter \'id\' is not present', 'Spring Boot', '2019-12-04 17:04:17', '2019-12-10 08:21:43', '6', '0', '<h2 style=\"font-size:24px;font-family:\" color:#4f4f4f;background-color:#ffffff;\"=\"\">\n	Required Integer parameter ‘id’ is not present\n	</h2>\n	<p>\n		<span style=\"color:rgba(0, 0, 0, 0.75);font-family:\" font-size:16px;background-color:#ffffff;\"=\"\">那是因为服务器需要从你的网址上获得id来查询，所以其实很简单，在问号后面提供参数即可</span> \n	</p>\n	<p>\n		<img src=\"https://img-blog.csdnimg.cn/20190908185625917.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1N0ZXBoYW5pZTE3Mzk1,size_16,color_FFFFFF,t_70\" alt=\"在这里插入图片描述\" /> \n	</p>', '问题解决', '2');
INSERT INTO `blog` VALUES ('32', 'Spring Boot  MyBatis概念篇', 'Spring Boot 集成 MyBatis', '2019-12-04 17:04:17', '2019-12-19 09:32:50', '15', '1', 'ORM框架<br />\n对象关系映射：Object Relational Mapping<br />\n出现原因：解决面向对象与关系型数据库的不匹配而产生的技术<br />\n具体实现：ORM 通过使用描述对象和数据库之间映射的元数据，将程序中的对象自动持久化到关系数据库中。<br />\nMybatis<br />\nMybatis就是一款标准的ORM框架，支持普通 SQL 查询，存储过程和高级映射的优秀持久层框架。<br />\nMyBatis 消除了几乎所有的JDBC 代码和参数的手工设置以及对结果集的检索封装。<br />\nMyBatis 可以使用简单的 XML 或注解用于配置和原始映射，将接口和 Java 的实体类映射成数据库中的记录。<br />\n<br />', 'ORM框架', '2');
INSERT INTO `blog` VALUES ('33', '答辩', '测试', '2019-12-04 17:04:17', '2019-12-10 09:44:12', '3', '0', '<img src=\"/upload/image/20191210/20191210094401_796.png\" alt=\"\" />', 'DEBUG', '3');
INSERT INTO `blog` VALUES ('34', '18271857187', 'dsa', '2020-06-26 15:41:46', '2020-06-26 15:50:29', '2', '0', '<p>\n	<img src=\"/upload/image/20200626/20200626155023_621.gif\" alt=\"\" />\n</p>\n<p>\n	dsa\n</p>', '', '2');
INSERT INTO `blog` VALUES ('36', '18271857187', 'dsa', '2020-06-27 09:56:23', '2020-06-27 09:56:23', '0', '0', 'dsa', 'dsa', '3');
INSERT INTO `blog` VALUES ('37', 'dsa', 'dsa', '2020-06-27 09:56:31', '2020-06-27 09:56:31', '0', '0', 'dsa', '', '3');
INSERT INTO `blog` VALUES ('38', '18271857187', 'd\'sa', '2020-06-27 13:27:22', '2020-06-27 13:27:22', '4', '0', '的撒', '', '3');
INSERT INTO `blog` VALUES ('39', 'f\'f\'f', 'ffff\'fff', '2020-06-27 13:41:02', '2020-06-28 09:24:35', '37', '0', 'fffdsdsadsssssssssssssssssss啊啊啊啊啊啊啊阿发是否得到广泛的你，大撒大撒，的，撒旦撒旦萨芬，房贷首付，大哥风，大锅饭大概，覆盖，梵蒂冈，梵蒂冈，梵蒂冈，梵蒂冈地方，广泛的，，臭小子臭小子v吗，f.af,ds/f,ds.fdsfdsdsadsa大撒大撒大撒大撒，大撒大撒大撒，大撒大撒，大撒大撒，大撒大撒大撒\n<p>\n	<img src=\"/upload/image/20200628/20200628091755_861.jpg\" width=\"700px\" height=\"393px\" alt=\"\" />\n</p>', '', '2');
...
-- Records of blogger
-- ----------------------------
INSERT INTO `blogger` VALUES ('1', 'admin', 'f6fdffe48c908deb0f4c3bd36c032e72', 'hh@huahaohh.cn', 'admin', '湖北省黄石市', '18271857187');
...
CREATE TABLE `blogtype` (
  ...
  `type_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '博客类别',
...
CREATE TABLE `comment` (
  ...
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '评论者',
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '评论者email',
  `content` varchar(10000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '评论内容',
  `comment_date` datetime DEFAULT NULL COMMENT '评论日期',
  `blog_id` int(11) DEFAULT NULL COMMENT '外键关联具体博客',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `t_comment_ibfk_1` (`blog_id`) USING BTREE
...
CREATE TABLE `link` (
  ...
  `link_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '友情链接名',
  `link_url` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '友情链接url',
  `order_num` int(11) DEFAULT NULL COMMENT '链接排序',
  PRIMARY KEY (`id`) USING BTREE
