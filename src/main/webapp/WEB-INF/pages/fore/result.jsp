        ...
        <div class="col-md-8 ">
            <c:forEach items="${blogList}" var="blog">
                <div class="blog-post">
                    <h2>${blog.title}</h2>
                    <h4>Posted by <a
                            href="${pageContext.request.contextPath}/about.do">BlackStar</a> ${blog.releaseDate} </h4>
                    <p>${blog.summary} </p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 foo-inner">
                <div class="fnav">
                    <p style="color: #fff; margin-right: 400px">Copyright © 2020 blackstar.All Right Reserved</p>
                    ...
                    <a target="_blank" href="http://www.beian.miit.gov.cn/" style="display:inline-block;margin-right: 390px"><p style="float:left;line-height:20px;margin: 0px 0px 0px 5px; color:#fff;">鄂ICP备19017946</p></a>
                </div>
            </div>
        </div>
    </div>
