                        ...
                        <p>
                            ...
                            <select id="blogTypeId" name="blogTypeId">
                                <c:forEach items="${blogTypeList}" var="blogType">
                                    <c:if test="${blog.blogTypeId == blogType.id}">
                                        <option selected="selected" value="${blogType.id}">${blogType.typeName}</option>
                                    </c:if>
                                    <c:if test="${blog.blogTypeId != blogType.id}">
...
<script>
    $(function () {
        $("#commit").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminBlog/edit";
            var blog = {
                id: id,
                title: title,
                summary: summary,
