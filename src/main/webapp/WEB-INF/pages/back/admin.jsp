...
<div id="wrap">
    ...
    <div class="leftMeun" id="leftMeun">
        ...
        <div id="personInfor">
            <p id="blogger">BlackStar</p>
            <p><span>751317151@qq.com</span></p>
            <p>
                <a href="${pageContext.request.contextPath}/admin/quit">退出登录</a>
            </p>
        </div>
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane active" id="blog">
                ...
                <div class="check-div form-inline">
                    <a href="${pageContext.request.contextPath}/adminBlog/compose">
                            ...
                            <c:forEach items="${pageInfo.blogList}" var="blog">
                                <div class="row">
                                    <a href="${pageContext.request.contextPath}/blog?id=${blog.id}">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" >
                                            <span class="glyphicon">${blog.title}</span>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">${blog.summary}</div>
                                        <c:forEach items="${blogTypeList}" var="blogType">
                                            <c:if test="${blogType.id == blog.blogTypeId}">
                                                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">${blogType.typeName}</div>
                                            </c:if>
                                        </c:forEach>
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                                ${blog.createTime}
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                        <a href="${pageContext.request.contextPath}/adminBlog/turnToEdit?id=${blog.id}">
                                            <button class="btn btn-success btn-xs" data-toggle="modal">修改</button>
                                        </a>

                                        <button class="btn btn-danger btn-xs" data-toggle="modal"
                                                data-target="#deleteSource" onclick="getId(${blog.id})">删除
                                        </button>
                        ...
                        <nav>
                            <ul class="pagination">
                                <c:if test="${pageInfo.currentPage != 1 && !empty pageInfo.blogList}">
                                    <li>
                                        <a style="color: #428bca;border: 1px solid #ddd" href="${pageContext.request.contextPath}/admin/manage"
                                           aria-label="Previous">
                                            <span aria-hidden="true">首页</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a style="color: #428bca;border: 1px solid #ddd" href="${pageContext.request.contextPath}/admin/manage?currentPage=${pageInfo.currentPage-1}"
                                           aria-label="Previous">
                                ...
                                <c:if test="${!empty pageInfo.blogList}">
                                    ...
                                    <c:forEach begin="${beginPage}" end="${endPage}" var="i">
                                        <c:if test="${pageInfo.currentPage == i}">
                                            <li>
                                                <a style="background-color: black;color: white;" href="${pageContext.request.contextPath}/admin/manage?currentPage=${i}">${i}</a>
                                            </li>
                                        </c:if>
                                        <c:if test="${pageInfo.currentPage != i}">
                                            <li>
                                                <a style="color: #428bca;border: 1px solid #ddd" href="${pageContext.request.contextPath}/admin/manage?currentPage=${i}">${i}</a>
                                            </li>
                                        </c:if>
                                    </c:forEach>
                                </c:if>
                        ...
                        <div class="modal-content">
                            ...
                            <form>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input id="deleteBlogBtn" class="btn btn-xs btn-danger" type="submit" value="确定删除"/>
                                </div>
                            </form>
                        ...
                        <c:if test="${!empty blogTypeList}">
                            <c:forEach items="${blogTypeList}" var="blogType">
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <button id="updateBlogTypeBtn" class="btn btn-success btn-xs" data-toggle="modal"
                                                data-target="#reviseBlogType" onclick="updateBlogType(${blogType.id})">
                                            修改
                                        </button>
                                        <button class="btn btn-danger btn-xs" data-toggle="modal"
                                                data-target="#deleteBlogType" onclick="getId(${blogType.id})">
                                            删除
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-xs-8 ">
                                                <input readonly="readonly" style="color: #222f3d" type="number" class="form-control input-sm duiqi" name="modifyId"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form>
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        删除此类型，博文也将一并删除。请确认：<br><br>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-xs btn-white" data-dismiss="modal">取 消</button>
                                    <input id="deleteBlogTypeBtn" class="btn  btn-xs btn-danger" type="submit" value="确认删除"/>
                                </div>
                            </form>
                        ...
                        <c:if test="${!empty commentList}">
                            <c:forEach items="${commentList}" var="comment">
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <a href="${pageContext.request.contextPath}/blog?id=${comment.blog_id}">
                                                ${comment.blogTitle}
                                        </a>
                                    </div>
                                    <div class="col-xs-2">
                                    ...
                                    <div class="col-xs-2">
                                        <button class="btn btn-success btn-xs" data-toggle="modal"
                                                data-target="#sendCommentEmail" onclick="getId(${comment.id})">
                                            发送邮件
                                        </button>
                                        <button class="btn btn-danger btn-xs" data-toggle="modal"
                                                data-target="#deleteComment" onclick="getId(${comment.id})">
                                            删除
                                        </button>
                                        <button class="btn btn-success btn-xs" data-toggle="modal"
                                                data-target="#sendCommentReply" onclick="getId(${comment.id})">
                                            回复
                                        </button>
                                    </div>
                                </div>
                        ...
                        <c:if test="${!empty replyList}">
                            <c:forEach items="${replyList}" var="reply">
                                <div class="row">
                                    ...
                                    <c:forEach items="${commentList}" var="comment">
                                        <c:if test="${comment.id == reply.commentId}">
                                            <div class="col-xs-2">
                                                    ${comment.content}
                                            </div>
                                            <div class="col-xs-2">
                                    ...
                                    <div class="col-xs-2">
                                        <a href="${pageContext.request.contextPath}/blog?id=${reply.blog_id}">
                                                ${reply.blogTitle}
                                        </a>
                                    </div>
                                    <div class="col-xs-2 ">
                                    ...
                                    <div class="col-xs-2">
                                        <button class="btn btn-danger btn-xs" data-toggle="modal"
                                                data-target="#deleteReply" onclick="getId(${reply.id})">
                                            删除回复
                                        </button>
                                    </div>
                                </div>
                        ...
                        <c:if test="${!empty linkList}">
                            <c:forEach items="${linkList}" var="link">
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <button class="btn btn-success btn-xs" data-toggle="modal"
                                                data-target="#modifyLink" onclick="updateLink(${link.id})">
                                            修 改
                                        </button>
                                        <button class="btn btn-danger btn-xs" data-toggle="modal"
                                                data-target="#deleteLink" onclick="getId(${link.id})">
                                            删 除
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-8 ">
                                                <input readonly="readonly" style="color: #222f3d" type="number" class="form-control input-sm duiqi"
                                                       name="modifyLinkId"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-xs btn-white" data-dismiss="modal">取 消</button>
                                    <input id="deleteLinkByIdBtn" class="btn  btn-xs btn-danger" type="submit" value="确认删除"/>
                                </div>
                            </form>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-xs-8 ">
                                                <input type="text" class="form-control input-sm duiqi"
                                                       ...
                                                       data-validation-required-message="Please enter blogger name." value="${blogger.username}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-xs-8 ">
                                                <input type="text" class="form-control input-sm duiqi"
                                                       ...
                                                       data-validation-required-message="Please enter blogger email." value="${blogger.email}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-xs-8 ">
                                                <input type="text" class="form-control input-sm duiqi"
                                                       ...
                                                       data-validation-required-message="Please enter blogger address." value="${blogger.address}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-xs-8 ">
                                                <input type="text" class="form-control input-sm duiqi"
                                                       ...
                                                       data-validation-required-message="Please enter blogger phone." value="${blogger.phone}">
                                            </div>
                                        </div>
...
<script src="../static/js/blogger/getHandleId.js"></script>
...
<script>
    $(function () {
        ...
        $("#deleteBlogBtn").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminBlog/deleteBlogById";
...
<script>
    $(function () {
        $("#blogTypeCommit").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminBlogType/addBlogType";
            var blogType = {
                typeName: typeName,
                orderNum: orderNum
            };
...
<script>
    function updateBlogType(id) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/getBlogTypeById",
            contentType: "application/json",
            type: "GET",
            data: {
                blogId: handleId
            ...
            success: function (result) {
                if(result != ""){
                    ...
                    $('#modifyTypeName').val(result.typeName),
                    $('#modifyOrderNum').val(result.orderNum)
                }
            }
        })
    };
    ...
    $(function () {
        ...
        $("#modifyBlogTypeCommit").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminBlogType/modifyBlogType";
            var blogType = {
                id: modifyId,
...
<script>
    ...
    $(function () {
        ...
        $("#deleteBlogTypeBtn").click(function () {
            var url = "${pageContext.request.contextPath}/adminBlogType/deleteBlogTypeById";
...
<script>
    ...
    $(function () {
        $("#sendCommentEmailBtn").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminCommentAndReply/sendCommentEmail";
            var email = {
                commentId: handleId,
                subject: subject,
                message: message
...
<script>
    $(function () {
        $("#sendCommentDeleteBtn").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminCommentAndReply/deleteCommentById";
            var comment = {
                id: handleId
            };
...
<script>
    ...
    $(function () {
        ...
        $("#sendCommentReplyBtn").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminCommentAndReply/replyComment";
...
<script>
    $(function () {
        $("#sendReplyDeleteBtn").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminCommentAndReply/deleteReplyById";
            var reply = {
                id: handleId
            };
...
<script>
    $(function () {
        $("#addLinkCommit").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminLinkController/addLink";
...
<script>
    function updateLink(id) {
        ...
        $.ajax({
            url: "${pageContext.request.contextPath}/getLinkById",
            contentType: "application/json",
            type: "GET",
            data: {
                linkId: handleId
            ...
            success: function (result) {
                if(result != ""){
                    console.log(result),
                        $('#modifyLinkId').val(result.id),
                        $('#modifyLinkName').val(result.linkName),
                        $('#modifyLinkUrl').val(result.linkUrl)
                        $('#modifyLinkOrderNum').val(result.orderNum)
                }
            }
        })
    };
    ...
    $(function () {
        $("#modifyLinkCommit").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/adminLinkController/modifyLink";
...
<script>
    ...
    $(function () {
        ...
        $("#deleteLinkByIdBtn").click(function () {
            var url = "${pageContext.request.contextPath}/adminLinkController/deleteLinkById";
...
<script>
    $(function () {
        $("#modifyBloggerInfoCommit").click(function () {
            ...
            var url = "${pageContext.request.contextPath}/admin/modifyBloggerInfo";
