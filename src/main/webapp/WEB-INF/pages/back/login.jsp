    ...
    <script type="text/javascript">
        ...
        function adminLogin() {
            ...
            if (username === "" || password === "") {
                ...
                var url = "${pageContext.request.contextPath}/checkLogin";
                var blogger = {
                    username: username,
                    password: password
                };
...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            <form class="fh5co-form animate-box" data-animate-effect="fadeIn">
                ...
                <div class="form-group">
                    <p>Not registered? <a href="${pageContext.request.contextPath}/forget">Forgot Password?</a>
                    </p>
                </div>
                <div class="form-group">
    ...
    <div class="row" style="padding-top: 60px; clear: both;">
        <div class="col-md-12 text-center"><p>Copyright &copy; all rights reserved 2020. BlackStar</p></div>
    </div>
</div>
