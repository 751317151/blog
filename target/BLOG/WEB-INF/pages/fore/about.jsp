...
<head>
    ...
    <title>BlackStar - BackStage Developer</title>
        ...
        function sendEmail() {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result === true) {
                        alert("留言成功，博主会在24小时内回复的！");
                        window.location.href = "${pageContext.request.contextPath}/about";
                    } else {
                        alert("留言失败！");
                        window.location.href = "${pageContext.request.contextPath}/about";
                    }
    ...
    <nav class="navbar navbar-custom">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="${pageContext.request.contextPath}/index"><spring:message
                        code="one_home"/></a></div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <span>
                            <h6>
                                <a class="page-scroll"
                                   href="${pageContext.request.contextPath}/locale?locale=zh">中</a>
                                |
                                <a class="page-scroll"
                                   href="${pageContext.request.contextPath}/locale?locale=en">US</a>
                            </h6>
                        </span>
                    </li>
                </ul>
...
<div id="about">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-center"><img src="static/img/about.jpg" class="img-responsive" alt="avatar">
            </div>
            <div class="col-md-8 col-md-offset-2">
                <div class="about-text">
                    <p><spring:message code="two_introduction_one"/></p>
                    <p><spring:message code="two_introduction_two"/></p>
                    <%--<p class="text-center"><a class="btn btn-primary" href="${pageContext.request.contextPath}/download"><i class="fa fa-download"></i>
        ...
        <div class="row">
            <div class="portfolio-items">
                ...
                <div class="col-sm-6 col-md-3 col-lg-3 app">
                    <div class="portfolio-item">
                        <div class="hover-bg"><a href="static/img/portfolio/02-large.jpg" title="Project description"
                                                 rel="prettyPhoto">
                            <div class="hover-text">
                                <h4>学校</h4>
                                <small>school</small></div>
                            <img src="static/img/portfolio/02-small.jpg" class="img-responsive" alt="Project Title">
                        </a></div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-lg-3 web">
            ...
            <div class="col-lg-12">
                <ul class="timeline">
                    ...
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Wuhan Textile University</h4>
                                <h4 class="subheading">Bachelor Degree in Computer Science and Technology</h4>
                            </div>
                            <div class="timeline-body">
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Huangshi No.2 Middle School</h4>
...
<div id="contact" class="text-center">
    <div class="container">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="social">
                <ul>
                    <li><a href="https://github.com/751317151"><i class="fa fa-github"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
