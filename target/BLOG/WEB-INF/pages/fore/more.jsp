            ...
            <nav>
                <ul class="pagination">
                    <c:if test="${pageInfo.currentPage != 1 && !empty pageInfo.blogList}">
                        <li>
                            <a href="${pageContext.request.contextPath}/moreBlog"
                               aria-label="Previous">
                                <span aria-hidden="true">首页</span>
                            </a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/moreBlog?currentPage=${pageInfo.currentPage-1}"
                               aria-label="Previous">
                    ...
                    <c:if test="${!empty pageInfo.blogList}">
                        ...
                        <c:forEach begin="${beginPage}" end="${endPage}" var="i">
                            <c:if test="${pageInfo.currentPage == i}">
                                <li>
                                    <a style="background-color: black;color: white;" href="${pageContext.request.contextPath}/moreBlog?currentPage=${i}">${i}</a>
                                </li>
                            </c:if>
                            <c:if test="${pageInfo.currentPage != i}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/moreBlog?currentPage=${i}">${i}</a>
                                </li>
                            </c:if>
                    ...
                    <c:if test="${pageInfo.currentPage != pageInfo.totalPage && !empty pageInfo.blogList}">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath }/moreBlog?currentPage=${pageInfo.totalPage}"
                               aria-label="Next">
